...
public class Pagination {
	...
	private int pages;			// 한 화면에 표시되는 페이지 번호 갯수
	private int currentPage;	// 요청한 페이지 번호
	private int totalRows;		// 전체 데이터 갯수
	
	/**
	 * 요청한 페이지 번호, 전체 데이터 갯수를 전달받아 Pagination객체를 초기화한다
	 * <p>한 화면에 표시되는 데이터 갯수는 10개다
	 * <p>한 화면에 표시되는 페이지 번호 갯수는 5개다
	...
	/**
	 * 요청한 페이지 번호, 전체 데이터 갯수, 한 화면에 표시할 행의 갯수를 전달 받아서 Pagination객체를 초기화한다
	 * <p>한 화면에 표시되는 페이지 번호 갯수는 5개다
	 * @param currentPage 요청한 페이지 번호
	 * @param totalRows 전체 데이터 갯수
	 * @param rows 한 화면에 표시되는 행의 ㄳ수
	 */
	...
	/**
	 * 요청한 페이지 번호, 전체 데이터 갯수, 한 화면에 표시할 행의 갯수, 한 화면에 표시할 페이지 번호 갯수를 전달받아서 Pagination객체를 초기화한다
	 * @param currentPage 요청한 페이지 번호
	 * @param totalRows 전체 데이터 갯수
	 * @param rows 한 화면에 표시되는 행의 갯수
	 * @param pages 한 화면에 표시되는 페이지 번호 갯수
	 */
	...
	/**
	 * 요청한 페이지 번호가 속한 페이지 블록 번호를 반환한다
	 * @return
	 */
	...
	/**
	 * 요청한 페이지 번호가 속한 페이지 블록의 시작 페이지 번호를 반환한다
	 * @return
	 */
	...
	/**
	 * 요청한 페이지 번호가 속한 페이지 블록의 끝 페이지 번호를 반환한다
	 * @return
	 */
