...
public class MultipartRequest {
	 ...
	 * <p>enctype="multipart/form-date" 요청을 처리하는 클래스
	 ...
	 * 
	 * <p>폼 입력값은 MultipartRequest가 제공하는 String getParameter(String name), String[] getParameterValues(String name)
	 * <p>첨부파일 이름은 MultipartRequest가 제공하는 String getFilename(String name)을 이용해서 조회할 수 있다
	 * @param request 요청객체
	 * @param saveDirectory 첨부파일 저장 디렉토리 경로
	 */
