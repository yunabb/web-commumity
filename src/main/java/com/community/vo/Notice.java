...
public class Notice {
	...
	private int postOriginalNo;		// 원글 번호
	...
	public int getPostOriginalNo() {
		return postOriginalNo;
	}
	public void setPostOriginalNo(int postOriginalNo) {
		this.postOriginalNo = postOriginalNo;
	}
